    ...
    class MainClass
    {
        ...
        public static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("9) Search Albums");
                ...
                else if (choice == "6")
                {
                    ...
                    var titles = movieFile.Movies.Where(m => m.title.Contains(moviesearch)).Select(m => m.title);
                ...
                var booktitles = bookFile.Books.Where(b => b.title.Contains(booktitle)).Select(b => b.title);
                ...
                else if (choice == "9")
                {
                    ...
                    var AlbumTitles = albumFile.Albums.Where(a => a.title.Contains(albumtitle)).Select(a => a.title);
                    foreach (string at in AlbumTitles)
                    {
